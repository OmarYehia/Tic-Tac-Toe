...
import tictactoe.Controllers.SinglePlayerNameController;

public class SinglePlayerNameBase extends StackPane {
    ...
    private SinglePlayerNameController controller;

    public SinglePlayerNameBase(Stage primaryStage, String difficulty) {
        ...
        player1Name.setLayoutX(163.0);
        player1Name.setLayoutY(329.0);
